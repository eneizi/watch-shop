(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{img:`/src/assets/site-produts/T1374101104100.jpg`,name:`Tissot`,price:5e4,id:1,description:`Описание часов — это структурированная характеристика устройства для измерения времени, которая включает в себя классификацию, особенности механизма, материалы корпуса, а также набор функциональных возможностей Описание часов — это структурированная характеристика устройства для измерения времени, которая включает в себя классификацию, особенности механизма, материалы корпуса, а также набор функциональных возможностей`},{img:`/src/assets/site-produts/A159WA-N1.jpg`,name:`Casio`,price:1e4,id:2},{img:`/src/assets/site-produts/71575ahtSiL._AC_SX679_.jpg`,name:`Orient`,price:3e4,id:3},{img:`/src/assets/site-produts/1102-0-3-45.jpg`,name:`NIKA`,price:3e6,id:4},{img:`/src/assets/site-produts/Rado3.jpg`,name:`Rado`,price:37e3,id:5},{img:`/src/assets/site-produts/RADO32500328.jpg`,name:`Rado`,price:52e3,id:6},{img:`/src/assets/site-produts/CITIZENNK5010-51L.jpg`,name:`Citizen`,price:45e3,id:7},{img:`/src/assets/site-produts/CITIZENAN8190-51L.jpg`,name:`Citizen`,price:23200,id:8},{img:`/src/assets/site-produts/SLGA009G.jpg`,name:`Grand Seiko`,price:15e5,id:9},{img:`/src/assets/site-produts/Rado3.jpg`,name:`Rado`,price:1e4,id:10},{img:`/src/assets/site-produts/T1374101104100.jpg`,name:`Tissot`,price:5e4,id:11},{img:`/src/assets/site-produts/A159WA-N1.jpg`,name:`Casio`,price:1e4,id:12},{img:`/src/assets/site-produts/71575ahtSiL._AC_SX679_.jpg`,name:`Orient`,price:3e4,id:13},{img:`/src/assets/site-produts/1102-0-3-45.jpg`,name:`NIKA`,price:3e6,id:14},{img:`/src/assets/site-produts/Rado3.jpg`,name:`Rado`,price:1e4,id:15},{img:`/src/assets/site-produts/CITIZENNK5010-51L.jpg`,name:`Citizen`,price:45e3,id:16}];function t(){let t=document.querySelector(`#shopping-basket`),n=document.querySelector(`#main-content`);document.querySelector(`#render-main`);let r=[],i=0,a=0;document.addEventListener(`click`,t=>{let n=t.target.closest(`#buy-product`);if(!n)return;let o=n.dataset.id,s=e.find(e=>e.id==o);r.find(e=>e.id==o)||(r.push(s),i+=s.price,a++)}),t.addEventListener(`click`,()=>{n.innerHTML=``;let e=document.createElement(`section`);e.className=`shopping-basket`,n.append(e);let t=document.createElement(`div`);if(t.className=`basket-summary-container`,e.append(t),r.length===0){e.innerHTML=`
    ...
    `)}function i(){document.querySelector(`#registration`).addEventListener(`click`,()=>{let e=document.querySelector(`#main-content`);e.innerHTML=`
        ...
        `,document.querySelector(`.back-to-main`).addEventListener(`click`,()=>{c(),r()})})}function a(){let t=document.querySelector(`#main-content`);document.addEventListener(`click`,n=>{if(n.target.closest(`.buy-product`))return;let r=n.target.closest(`.product-block`);if(!r)return;let i=r.dataset.id,a=e.find(e=>e.id==i);t.innerHTML=`
        <div class="product-card-block" data-id="${a.id}">
            <img class="product-card-img" src=${a.img}>
            <div class="product-card-info">
                <div>
                    <h3 class="product-card-name">${a.name}</h3>
                    <p class="product-card-price">${a.price}руб.</p>
                </div>
                <div class="product-card-btn-container">
                    <button data-id="${a.id}" class="product-card-buy" id="buy-product">
                        Добавить в коризну
                    </button>
                </div>
                <p class="product-card-description">
                    ${a.description?a.description:`Описания нет`}
                </p>
            </div>
        </div>
        `})}var o=document.querySelector(`#render-main`),s=document.querySelector(`#main-content`);function c(){s.innerHTML=`
